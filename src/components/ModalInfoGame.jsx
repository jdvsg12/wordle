...
function ModalInfoGame() {
  ...
  return (<>
    ...
    <article className={modal}>
      <h2 className="text-center font-bold text-lg md:text-3xl mb-2 dark:text-white">Cómo jugar</h2>
      <p className="text-sm md:text-lg my-1 dark:text-white">Adivina la palabra oculta en cinco intentos.</p>
      <p className="text-sm md:text-lg my-1 dark:text-white">Cada intento debe ser una palabra válida de 5 letras.</p>
      <p className="text-sm md:text-lg my-1 dark:text-white">Después de cada intento el color de las letras cambia para mostrar qué tan cerca estás de acertar la palabra.</p>
      <h3 className="text-sm md:text-lg font-bold dark:text-white">Ejemplos</h3>
      ...
      <p className="text-sm md:text-lg my-1">La letra <b>G</b> está en la palabra y en la posición correcta.</p>
      <ul className="flex justify-around my-3">
      ...
      <p className="text-sm md:text-lg my-1">La letra <b>C</b> está en la palabra pero en la posición incorrecta.</p>
      <ul className="flex justify-around my-3">
      ...
      <p className="text-sm md:text-lg my-1">La letra <b>O</b> no está en la palabra.</p>
      <p className="text-sm md:text-lg my-1">Puede haber letras repetidas. Las pistas son independientes para cada letra.</p>
      <p className="text-sm md:text-lg my-1 text-center">¡Una palabra nueva cada 5 minutos!</p>
